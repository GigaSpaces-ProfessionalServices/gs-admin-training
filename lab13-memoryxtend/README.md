# gs-admin-training - lab13-memoryxtend
...
1. Open `$GS_ADMIN_TRAINING_HOME/lab13-memoryxtend` project with Intellij (open the pom.xml).
2. Run mvn package
```
    ~/gs-admin-training/lab13-memoryxtend$ mvn package
    
    
    [INFO] Reactor Summary:
    [INFO] 
    [INFO] lab13-memoryxtend ............................................... SUCCESS [  0.204 s]
...
``` 
./gs.sh pu deploy BillBuddySpace ~/gs-admin-training/lab13-memoryxtend/BillBuddy_Space/target/BillBuddy_Space.jar 
```
...
./gs.sh pu deploy BillBuddySpace ~/gs-admin-training/lab13-memoryxtend/BillBuddy_Space/target/BillBuddy_Space.jar
```
Go to the new UI (new Ops manager) and see that all records were restored from the disk back to the space.  
