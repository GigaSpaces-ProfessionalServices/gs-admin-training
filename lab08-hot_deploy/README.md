# gs-admin-training - lab08-hot_deploy
 ...
 * Run the BillBuddy application. - as you did already in lab04.
...
The steps are the same as you have done in lab04-BillBuddy_training_example.
...
1. Open `$GS_ADMIN_TRAINING/lab08-hot_deploy` project with Intellij (open pom.xml).
2. Run `mvn package`
```
   `~/gs-admin-training/lab08-hot_deploy$ mvn package`
    
    
    [INFO] Reactor Summary:
    [INFO] 
    [INFO] lab08-hot_deploy ............................................... SUCCESS [  0.204 s]
...
4. Use the gs CLI to deploy BillBuddy_Space.  
   `./gs.sh pu deploy BillBuddyPU ~/gs-admin-training/lab08-hot_deploy/BillBuddy_Space/target/BillBuddy_Space.jar`
...
2. Copy the `~/gs-admin-training/lab08-hot_deploy/runConfigurations` directory into Intellij's .idea directory and restart Intellij.
```
  cd ~/gs-admin-training/lab08-hot_deploy
...
1. Open `~/gs-admin-training/lab08-hot_deploy/BillBuddy_Space/src/main/java/com/gs/billbuddy/events/ProcessingFeePollingEventContainer.java` class with IntelliJ.
...
```    
    ...
    [INFO] Reactor Summary:
    [INFO] 
    [INFO] lab08-hot_deploy .............................................. SUCCESS [  0.215 s]
...
```
    cd ~/gs-admin-training/lab08-hot_deploy/BillBuddy_Space/target
